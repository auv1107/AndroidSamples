...
package com.sctdroid.app.samples.widget;
...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabStrip.setSelectedIndicatorColor(a.getColor(R.styleable.TabLayout_tabIndicatorColor, 0), Color.RED);
        ...
        mTabStrip.setSelectedIndicatorMargin(dpToPx(25), dpToPx(25));
        mTabStrip.setSelectedIndicatorHeight(10);
